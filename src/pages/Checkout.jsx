                        ...
                        <div className="checkout-left-data">
                            ...
                            <nav style={{ "--bs-breadcrumb-divider": ">" }} aria-label="breadcrumb">
                                <ol className="breadcrumb">
                                    <li className="breadcrumb-item"><Link className='text-dark total-price' href="/cart">Cart</Link></li>  &nbsp; /
                                    <li className="breadcrumb-item active" aria-current="page">Information</li> &nbsp; /
                                    <li className="breadcrumb-item"><Link className='text-dark' href="#">Shipping</Link></li>  &nbsp; /
                                    <li className="breadcrumb-item active" aria-current="page">Payment</li>
                                </ol>
                            </nav>
                            <h4 className="title total">Contact Information</h4>
                            <p className="user-details total">Ganga Ram Jaisi (ganaramjaisi09@gmail.com)</p>
                        ...
                        <div className='border-bottom py-4'>
                            <div className="d-flex gap-10 mb-2 align-items-center">
                                <div className='w-75 d-flex gap-10'>
                                    ...
                                    <div>
                                        <h5 className="total-price">fddhfd title</h5>
                                        <p className='total-price'>s/#agfgedfjdfkddkdf</p>
                                    </div>
                                </div>
                                <div className='flex-grow-1'>
